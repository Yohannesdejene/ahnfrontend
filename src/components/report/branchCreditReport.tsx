...
const BranchCreditShipment: React.FC<GradeDetailProps> = ({ id }) => {
  ...
  return (
    <div className="mx-auto max-w-230" style={{ maxWidth: "90vw" }}>
      <label className="mb-12  block text-title-lg font-medium text-black dark:text-white">
        Branch Credit Shipments Report
      </label>
      {errorShipments && (
      ...
      <FormProvider {...methods}>
        <div className="bg-white p-2 md:p-5">
          <div className="w-full ">
            <div className="mb- grid w-full grid-cols-1 gap-3 md:grid-cols-3 lg:grid-cols-6">
          ...
          <div className="justify-left flex gap-4  align-middle">
      ...
      <div className="auto flex bg-white text-black dark:bg-boxdark dark:text-white">
...
export default BranchCreditShipment;
